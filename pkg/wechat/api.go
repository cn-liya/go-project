...
type ServerAPI interface { //服务端接口，需提供access_token
	GetUserPhoneNumber(ctx context.Context, code string) (*GetUserPhoneNumberResp, error)
	GetDailySummary(ctx context.Context, args *DatacubeArgs) (*GetDailySummaryResp, error)
	GetDailyVisitTrend(ctx context.Context, args *DatacubeArgs) (*VisitTrendResp, error)
	GetWeeklyVisitTrend(ctx context.Context, args *DatacubeArgs) (*VisitTrendResp, error)
}
